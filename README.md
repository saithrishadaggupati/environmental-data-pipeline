...
**Pipeline components:**
- fetch_aqi.py — pulls live AQI for 101 cities with retry logic: 3 attempts per city, 2-second backoff, 10-second timeout, automatic failed-city tracking with full logging
- clean_aqi.py — validates data with Pydantic, assigns air quality labels and city tier classification
...
- Hypothesis test — Mann-Whitney U test comparing North vs South India AQI — p-value 0.009, statistically significant
...
- City tier column in full data table — Metro, Tier-1, Tier-2, Tier-3
